(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=cicia';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_ad334ae347a22636e8cc1f38cedd254cdc0be2e56ab7dae3fea5eb280192752f";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/cicia-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/cicia-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/cicia-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
        ...
        .q-btn-trigger-ia {
            position: absolute; top: 90px; right: 14px; z-index: 100;
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://acdn-us.mitiendanube.com/stores/001/905/696/themes/common/logo-4296861231879100211-1771871493-d11edbbc9289e8704619722489899a2d1771871493-480-0.webp" alt="CICIA" style="height:48px;width:auto;"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=cicia" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=cicia" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
    ...
    function buyNow() {
        ...
        try {
            ...
            var _td = (document.querySelector('h1.js-product-name,h1.product__title,.product-single__title,h1') || {}).innerText || document.title || '';
    ...
    function populateBuyCta() {
        ...
        var prodName = (document.querySelector('h1.js-product-name,h1.product__title,.product-single__title,h1') || {}).innerText || document.title || '';
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'cicia', origin: location.origin })
                    });
                    pix = await resp.json();
